...
namespace Demo.PureMVC.EmployeeAdmin.View
{
    public class UserListMediator : Mediator, IMediator
    {
        ...
        void userList_NewUser()
        {
            ...
            SendNotification(NotificationConst.NEW_USER, user);
        }

        void userList_DeleteUser()
        {
            SendNotification(NotificationConst.DELETE_USER, UserList.SelectedUserData);
        }

        void userList_SelectUser()
        {
            SendNotification(NotificationConst.USER_SELECTED, UserList.SelectedUserData);
        }
        ...
        public override IList<string> ListNotificationInterests()
        {
            ...
            list.Add(NotificationConst.USER_UPDATED);
            return list;
        }
